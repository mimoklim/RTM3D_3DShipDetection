...
class CarPoseDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        pix_dist = np.zeros((self.max_objs, 2), dtype=np.float32)
        ...
        ret = {'input': inp, 'hm': hm, 'reg_mask': reg_mask, 'ind': ind, 'wh': wh,
               'hps': kps, 'hps_mask': kps_mask,'dim': dim, 'pix_dist': pix_dist,'rotbin': rotbin, 'rotres': rotres,
