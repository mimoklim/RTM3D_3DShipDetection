# RTM3D_3DShipDetection
This project is based on [RTM3D](https://github.com/Banconxuan/RTM3D), an efficient monocular 3D object detection framework originally developed for autonomous driving.
